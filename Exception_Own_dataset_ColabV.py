...
matplotlib.use('Agg')
current_directory = '/content/drive/My Drive/101_ObjectCategories'
...
def main(args):
    ...
    args.dataset_root = '/content/drive/My Drive/101_ObjectCategories'
    args.result_root = '/content/drive/My Drive/result'
    args.classes = '/content/drive/My Drive/classes.txt'
